...
test('tools/list uses top-level JSON-schema object forms only', () => {
    ...
    assert.deepEqual(tools.map(function (tool) { return tool.name; }), ['ae_status', 'ae_exec', 'ae_previewFrame', 'ae_read', 'ae_checkpoint', 'ae_revert', 'ae_validateExpressions', 'ae_nativeExec']);
