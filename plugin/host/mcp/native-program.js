...
function assertCanonicalValue(value, depth) {
    ...
    if (typeof value === 'string') {
        if (hasUnpairedSurrogate(value)) throw new TypeError('native JSON contains an invalid Unicode scalar');
        return;
    }
...
function canonicalNumber(value) {
    ...
    // Python json.dumps and JSON.stringify agree for ordinary finite decimal
    // values. Exponent notation is intentionally rejected because their
    // thresholds and spelling differ; native Core contracts do not need it.
