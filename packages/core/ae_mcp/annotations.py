...
VERB_ANNOTATIONS: dict[str, ToolAnnotations] = {
    ...
    "ae.getProjectContext": _ann(True, False, True),
    "ae.getProjectItemMetadata": _ann(True, False, True),
    "ae.getCompositionSettings": _ann(True, False, True),
    "ae.setCompositionWorkArea": _ann(False, False, True),
    "ae.renameProjectItem": _ann(False, False, True),
    "ae.setProjectItemComment": _ann(False, False, True),
    "ae.setProjectItemLabel": _ann(False, False, True),
    "ae.duplicateComposition": _ann(False, False, True),
    ...
    "ae.getLayerDetails": _ann(True, False, True),
    "ae.getLayerCompositingState": _ann(True, False, True),
    "ae.setLayerVisibility": _ann(False, False, True),
    "ae.setLayerSolo": _ann(False, False, True),
    "ae.setLayerLocked": _ann(False, False, True),
    "ae.setLayerShy": _ann(False, False, True),
    "ae.setLayerMotionBlur": _ann(False, False, True),
    "ae.setLayerThreeD": _ann(False, False, True),
    "ae.setLayerAdjustment": _ann(False, False, True),
    "ae.setLayerQuality": _ann(False, False, True),
    "ae.setLayerBlendingMode": _ann(False, False, True),
    "ae.getLayerTransform": _ann(True, False, True),
    "ae.setLayerAnchorPoint": _ann(False, False, True),
    "ae.setLayerPosition": _ann(False, False, True),
    "ae.setLayerScale": _ann(False, False, True),
    "ae.setLayerRotation": _ann(False, False, True),
    "ae.setLayerOpacity": _ann(False, False, True),
    "ae.setLayerOrientation": _ann(False, False, True),
    "ae.renameLayer": _ann(False, False, True),
    "ae.setLayerRange": _ann(False, False, True),
    "ae.setLayerStartTime": _ann(False, False, True),
    "ae.setLayerStretch": _ann(False, False, True),
    "ae.reorderLayer": _ann(False, False, True),
    "ae.setLayerParent": _ann(False, False, True),
    "ae.duplicateLayer": _ann(False, False, True),
    ...
    "ae.getLayerPropertyKeyframeDetails": _ann(True, False, True),
    "ae.addLayerPropertyKeyframe": _ann(False, False, True),
    "ae.setLayerPropertyKeyframeValue": _ann(False, False, True),
    "ae.setLayerPropertyKeyframeInterpolation": _ann(False, False, True),
    "ae.setLayerPropertyKeyframeTemporalEase": _ann(False, False, True),
    "ae.setLayerPropertyKeyframeBehavior": _ann(False, False, True),
    "ae.deleteLayerPropertyKeyframe": _ann(False, True, True),
