...
_ROWS = (
    ...
    _call("marker-composition-reacquire", "ae_listProjectItems", {"offset": 0, "limit": 50}, "read", "After shape graph writes, reacquire the named composition before enumerating fresh marker targets."),
    _call("cross-family-layers", "ae_listCompositionLayers", {"composition_locator": "$composition_locator", "offset": 0, "limit": 25}, "read", "Text and shape layers coexist and supply fresh public locators for both marker targets."),
...
T5_ADDRESS_LINKS = (
    ...
    AddressLink(27, "composition_locator", 26, "value.items[TSM Acceptance Fixture].locator"),
    AddressLink(28, "target.layer_locator", 27, "value.layers[TSM Text].locator"),
    AddressLink(29, "target.layer_locator", 27, "value.layers[TSM Shape].locator"),
    AddressLink(30, "target", 28, "value.after.ref.target"),
    AddressLink(31, "target", 29, "value.after.ref.target"),
    AddressLink(32, "marker_ref", 30, "value.markers[0].ref"),
    AddressLink(33, "target", 32, "value.after.ref.target"),
    AddressLink(34, "marker_ref", 31, "value.markers[0].ref"),
    AddressLink(35, "target", 34, "value.before.ref.target"),
    AddressLink(36, "layer_locator", 27, "value.layers[TSM Text].locator"),
    AddressLink(37, "target", 35, "value.target"),
    AddressLink(38, "target", 33, "value.target"),
    AddressLink(39, "layer_locator", 27, "value.layers[TSM Shape].locator"),
    AddressLink(40, "layer_locator", 39, "value.layerLocator"),
    AddressLink(41, "composition_locator", 27, "value.compositionLocator"),
