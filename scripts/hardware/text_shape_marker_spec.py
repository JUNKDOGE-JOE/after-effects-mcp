...
T5_ADDRESS_LINKS = (
    ...
    AddressLink(26, "composition_locator", 14, "value.compositionLocator"),
    AddressLink(27, "target.layer_locator", 26, "value.layers[TSM Text].locator"),
    AddressLink(28, "target.layer_locator", 26, "value.layers[TSM Shape].locator"),
    AddressLink(29, "target", 27, "value.after.ref.target"),
    AddressLink(30, "target", 28, "value.after.ref.target"),
    AddressLink(31, "marker_ref", 29, "value.markers[0].ref"),
    AddressLink(32, "target", 31, "value.after.ref.target"),
    AddressLink(33, "marker_ref", 30, "value.markers[0].ref"),
    AddressLink(34, "target", 33, "value.before.ref.target"),
    AddressLink(35, "layer_locator", 26, "value.layers[TSM Text].locator"),
    AddressLink(36, "layer_locator", 26, "value.layers[TSM Shape].locator"),
    AddressLink(37, "target", 34, "value.target"),
    AddressLink(38, "target", 32, "value.target"),
    AddressLink(39, "layer_locator", 36, "value.layerLocator"),
    AddressLink(40, "layer_locator", 39, "value.layerLocator"),
    AddressLink(41, "composition_locator", 26, "value.compositionLocator"),
